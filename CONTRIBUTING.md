...
It’s time to build the icons and theme definitions! This is handled by another run configuration, `build themes`.

### Extra: Update Repo

Use the run configuration, `update build theme deps`, to pull the latest changes from GitHub for the repo dependencies.
...
Use run configuration, `test plugin`.
